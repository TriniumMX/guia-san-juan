      ...
      {editar && (
        <>
          ...
          <span className="pf-note">
            Coordenadas opcionales. Si las dejas vacías, usamos la dirección para el botón “Cómo llegar”.
            Puedes rellenarlas solas con el botón de la sección <b>Coordenadas del mapa</b> (guarda primero la dirección).
          </span>
          <div className="pf-row">
